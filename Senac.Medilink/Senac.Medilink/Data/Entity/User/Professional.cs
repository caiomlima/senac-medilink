...
public class Professional : BaseEntity
{
    ...
    public virtual ICollection<ProfessionalSpecialty> ProfessionalSpecialties { get; private set; } // index | para buscar o profissional por tipo de especialidade na hora de agendar
